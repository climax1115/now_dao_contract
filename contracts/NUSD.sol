...
contract NUSD is ERC20Permit, Ownable {
    ...
    constructor() ERC20("NowUSD", "NUSD", 18) ERC20Permit() {
    ...
    /**
        @notice increases Nusdnuts supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Nusdnuts
