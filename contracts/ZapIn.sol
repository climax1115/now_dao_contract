///@notice This contract adds liquidity to PancakeSwap pools on Avalanche using BNB or any ERC20 Tokens.
...
interface INowDaoBondDepository {
    function deposit( uint _amount, uint _maxPrice, address _depositor) external returns ( uint );
}

contract NowDao_ZapIn_V1 is ZapInBaseV3_1 {
    using SafeERC20 for IERC20;

    mapping (INowDaoBondDepository => address) public allowedPairs;
    mapping (INowDaoBondDepository => address) public allowedReserves;

    IUniswapV2Factory private constant pancakeFactory =
        IUniswapV2Factory(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc);

    IUniswapV2Router02 private constant pancakeRouter =
    ...
    constructor()
    {
        ...
        //allowedPairs
        allowedPairs[INowDaoBondDepository(0x860209C715e25f7f89Ed359AaD620207b0fc25eb)] = 0x9a256121528DC09207A8080e4c68103407f9CBCA;
        allowedPairs[INowDaoBondDepository(0x35d0e326EC85B2bC2Be5888415c7a3a7E2c92A6d)] = 0x465155142C62A7A26060Ae7802966612a55a7748;

        //allowedReserves
        allowedReserves[INowDaoBondDepository(0x2a4f14B266F5B764EF20E4f988Fd974449fD7Ef9)] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
        allowedReserves[INowDaoBondDepository(0xcbC301C71269a80D9522651ae8C2d87e8E7cEe0D)] = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    }
    ...
    function ZapInLp(
        ...
        INowDaoBondDepository _bondDepository,
        uint256 _amount,
    ...
    function _uniDeposit(
        ...
        _approveToken(_ToUnipoolToken0, address(pancakeRouter), token0Bought);
        _approveToken(_ToUnipoolToken1, address(pancakeRouter), token1Bought);
